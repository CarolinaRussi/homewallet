...
export const messages = {
  "pt-BR": {
    ...
    "auth.errorPasswordMin": "A senha precisa ter pelo menos 8 caracteres.",
    "auth.errorPasswordRequired": "Informe a senha.",
  ...
  en: {
    ...
    "auth.forgotHint":
      "We'll send a link if an account with a password exists for that email.",
    "auth.forgotSubmit": "Send link",
    "auth.forgotSending": "Sending…",
    "auth.forgotSent":
      "If an account with a password exists, the email is on its way.",
    "auth.backToSignIn": "Back to sign in",
    "auth.resetTitle": "New password",
    "auth.resetHint": "Choose a password with at least 8 characters.",
