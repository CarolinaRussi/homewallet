...
> Status: **Part 12b — Credit card detail**. Optional statement lines + auto Outros; optional parcelas seed future Cartão statements (seeded bump vs manual no-bump). Deploy is owner-driven later.
